...
package net.yuanmomo.tools.db.orm.mybatis.generator.plugin.business;
...
public class BusinessPlugin extends PluginAdapter {
	...
	public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(
		...
		if(StringUtil.isBlank(generatedBusinessPackage)){
        ...
        String mapperFieldName = StringUtil.lowerFirstChar(mapperFieldNameType.getShortName());
