/**
 * Project Name : Tools
 * File Name    : DefaultVFS.java
 * Package Name : net.yuanmomo.tools.util.bean
 * Created on   : 2014-3-14下午4:18:40
 * Author       : Hongbin Yuan
 * Blog         : yuanmomo.net
 * Company      : 成都逗溜网科技有限公司  
 */

package net.yuanmomo.tools.util.clazz.vfs;
...
import net.yuanmomo.tools.util.clazz.ResolverUtil;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * ClassName : DefaultVFS Function : TODO ADD FUNCTION. Reason : TODO ADD
 * REASON. Date : 2014-3-14 下午4:18:40
 * 
 * @author : Hongbin Yuan
 * @version
 * @since JDK 1.6
